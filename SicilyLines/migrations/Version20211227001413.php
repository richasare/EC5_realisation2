 ...
 */
final class Version20211227001413 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD le_client_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C84955C0F37DD6 FOREIGN KEY (le_client_id) REFERENCES client (id)');
